...
| Mars (`admin@repo.example.edu:/Users/Shared/Cimian/deployment/`) | On-campus HTTP origin (`http://repo.example.edu/deployment`) | `scp` after `makecatalogs` |
...
```powershell
sudo makecatalogs
scp deployment/pkgsinfo/apps/modeling/MyApp-*.yaml admin@repo.example.edu:/Users/Shared/Cimian/deployment/pkgsinfo/apps/modeling/
scp deployment/catalogs/Production.yaml deployment/catalogs/All.yaml admin@repo.example.edu:/Users/Shared/Cimian/deployment/catalogs/
