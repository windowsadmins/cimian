...
public class ConfigurationService
{
    ...
    /// Intune configuration profile instead of per-device file edits ([tracked internally]).
    ///
    ...
    /// forced the whole fleet onto the enrollment manifest and ORPHANED devices ([tracked internally]);
